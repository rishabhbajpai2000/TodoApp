...
import 'package:todo_app/services/c_r_u_d_notes_service.dart' as _i6;
import 'package:todo_app/services/Note.dart' as _i7;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockCRUDNotesService extends _i1.Mock implements _i6.CRUDNotesService {
  @override
  void create(String? text) => super.noSuchMethod(
        Invocation.method(
          #create,
          [text],
        ),
  ...
  @override
  List<_i7.Note> read() => (super.noSuchMethod(
        Invocation.method(
          #read,
          [],
        ),
        returnValue: <_i7.Note>[],
        returnValueForMissingStub: <_i7.Note>[],
      ) as List<_i7.Note>);
